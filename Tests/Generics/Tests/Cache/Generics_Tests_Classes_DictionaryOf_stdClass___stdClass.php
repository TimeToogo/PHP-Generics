...
class stdClass implements \ArrayAccess, \Iterator, \Countable
{
    private $Keys = array();
    ...
    private function VerifyValue($Value)
    {
        if (!$Value instanceof \stdClass) {
            throw new \InvalidArgumentException(sprintf('Value for dictionary must be of type %s: %s given', 'stdClass', get_class($Value)));
        }
    }
